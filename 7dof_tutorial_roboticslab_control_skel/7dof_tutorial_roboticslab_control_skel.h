 ...
 */
#ifndef __MY7DOF_TUTORIAL_ROBOTICSLAB_CONTROL_SKEL_H__
#define __MY7DOF_TUTORIAL_ROBOTICSLAB_CONTROL_SKEL_H__
...
class REXPORT My7dof_tutorial_roboticslab_control_skel : public rControlAlgorithmEx
#else
class REXPORT My7dof_tutorial_roboticslab_control_skel : public rControlAlgorithm
#endif
{
public:
	My7dof_tutorial_roboticslab_control_skel(rDC rdc);
	~My7dof_tutorial_roboticslab_control_skel();
